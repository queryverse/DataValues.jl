...
@deprecate DataValueCategoricalArray{T, N}(::Type{T}, dims::NTuple{N,Int}; ordered=false) DataValueCategoricalArray{T}(dims, ordered=ordered)
@deprecate DataValueCategoricalArray{T}(::Type{T}, dims::Int...; ordered=false) DataValueCategoricalArray{T}(dims, ordered=ordered)

@deprecate CategoricalVector{T}(::Type{T}, m::Integer; ordered=false) CategoricalVector{T}(m, ordered=ordered)
@deprecate DataValueCategoricalVector{T}(::Type{T}, m::Integer; ordered=false) DataValueCategoricalVector{T}(m, ordered=ordered)

@deprecate CategoricalMatrix{T}(::Type{T}, m::Int, n::Int; ordered=false) CategoricalMatrix{T}(m, n, ordered=ordered)
@deprecate DataValueCategoricalMatrix{T}(::Type{T}, m::Int, n::Int; ordered=false) DataValueCategoricalMatrix{T}(m, n, ordered=ordered)
